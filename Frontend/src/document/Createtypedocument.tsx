...
function CreateTypeDocument({ onsuccess }: CreateTypeDocumentProps) {
                    ...
                    <div className="td-form-grid">
                        <div className="form-field td-span2">
                            <input
                                ...
                                required
                            />
                            <label htmlFor="td-nom">Nom du type de document</label>
                        </div>
                        <div className="form-field">
                            <input
                                ...
                                required
                            />
                            <label htmlFor="td-retention">Durée de rétention (années)</label>
                        </div>
                        <div className="form-field">
                            <input
                                id="td-grace"
                            ...
                            />
                            <label htmlFor="td-grace">Période de grâce (jours)</label>
                        </div>
                    </div>
                </div>
                        ...
                        {metaData.map((meta, index) => (
                            <div key={index} className="td-meta-row">
                                ...
                                <div className="form-field td-meta-nom">
                                    <input
                                        type="text"
                                        id={`meta-nom-${index}`} // 1. Ajout d'un ID unique basé sur l'index
                                        className="form-field-input"
                                        placeholder=" "
                                        value={meta.nom}
                                        ...
                                        required
                                    />
                                    {/* 2. Liaison avec htmlFor qui pointe vers l'ID de l'input */}
                                ...
                                >
                                    {/* Correction ici : class devient className */}
